...
public class DriverManager {
    ...
    public static void launchBrowser(String platform, String deviceName, String platformVersion, String platformName) throws MalformedURLException {
        ...
        if (platform.equalsIgnoreCase("lambda")) {
            ...
            capabilities.setCapability("app", getData("appUrl.qcharge_" + ConfigManager.getOperatingSystem() + ""));
            capabilities.setCapability("build", "Gcharge - " + ConfigManager.getOperatingSystem() + " Test Automation");
            ...
            DesiredCapabilities capabilities = new DesiredCapabilities();
            capabilities.setCapability(APPLICATION_NAME, getData("apk.hepsiburada_" + ConfigManager.getOperatingSystem() + ""));
            ...
            capabilities.setCapability(DEVICE_NAME, "e82d9c6b"); //emulator değilse terminalden şunun gibi bir id alınır ->  e82d9c6b
