...
public class ConfigManager {
   ...
   private static final String TEST_CONFIG_FILE = Paths.get("src/test/resources/app.properties").toString();
    ...
    public static Integer getWaitTimeSplashScreen() {
        return Integer.parseInt(System.getProperty("wait.time.splash", getStringValue("wait.time.splash", String.valueOf(10))));
    }
